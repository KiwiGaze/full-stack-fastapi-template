...
- **Existing components**: Continue using Chakra UI
- **New components**: Use shadcn/ui + TailwindCSS
- **Design consistency**: Maintain Clinical Blue design system across both libraries
